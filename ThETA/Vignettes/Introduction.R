...
## ---- t2d_sco, cache.lazy = TRUE, echo = TRUE----------------------------
...
## ---- t2d_plot1, fig.width=7, fig.height=3, cache.lazy = TRUE, echo = TRUE----
library(ggplot2)
library(reshape)
...
## ---- t2d_plot2, fig.width=7, fig.height=3, cache.lazy = TRUE, echo = TRUE----
library(ggplot2)
library(reshape)
...
## ---- ppv_plot, fig.width=7, fig.height=3, cache.lazy = TRUE, echo = TRUE, message = FALSE----
data(GS_TTD)
data(GS_DBK)
